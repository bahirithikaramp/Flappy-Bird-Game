...
def score_display(game_state):
    ...
    if game_state == 'game_over':
        ...
        high_score_rect = score_surface.get_rect(center = (248,23 ))
...
pygame.init()
screen = pygame.display.set_mode((576,825))
...
bird_rect = bird_surface.get_rect(center = (100,412.5))
...
game_over_rect =  game_over_surface.get_rect(center = (288,412.5))
